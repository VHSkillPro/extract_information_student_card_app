...
class StudentCardTextDetectionService {
  // Singleton pattern
  static final StudentCardTextDetectionService _instance =
      StudentCardTextDetectionService._internal();

  factory StudentCardTextDetectionService() {
    return _instance;
  }
  ...
  static const String _detModelPath =
      "assets/weights/detection/db_mv3_student.nb";
  ...
  Future<List<Bbox>> detect(Uint8List imageBytes) async {
    if (!_initialized) {
      throw Exception('StudentCardTextDetectionService not initialized!');
    }
