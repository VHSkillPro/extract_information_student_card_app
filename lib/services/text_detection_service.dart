...
class TextDetectionService {
  // Singleton pattern
  static final TextDetectionService _instance =
      TextDetectionService._internal();

  factory TextDetectionService() {
    return _instance;
  }
  ...
  Future<void> initialize() async {
    ...
    logger.d("[TextDetectionService] 🔧 Loading model...");
    ...
    logger.d('[TextDetectionService] ✅ Model loaded successfully!');
  }
  ...
  Future<DetResultList> detect(Uint8List imageBytes) async {
    if (!_initialized) {
      throw Exception('TextDetectionService not initialized!');
    }
